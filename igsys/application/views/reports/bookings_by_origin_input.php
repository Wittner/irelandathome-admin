...
<div>
<p align="center"><strong>Bookings by origin</strong></p>
...
<tr>
      ...
      <td class="normal" valign="top">
	  <?=form_open('reports/bookings_by_origin_report');?>
...
<tr>
	<td class="normal"><p class="caption">Filter by origin:</p></td>
	<td class="normal">
	<select name="origin">
	<option value="any" selected>Any</option>
	<option value="LB">Live bookings</option>
	<option value="OA">Offer acceptance</option>
	<option value="ADMIN">By administrator</option>
	</select>
	</td>
</tr>

...
<div>
<p align="center"><strong>Sales Report by departure date</strong></p>
...
<tr>
      ...
      <td class="normal" valign="top">
	  <?=form_open('reports/sales_report_by_departure_date');?>
...
<tr>
<td class="normal"><p class="caption">Filter by customer email:</p></td>
<td class="normal">

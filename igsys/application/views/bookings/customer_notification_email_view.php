...
switch ($status){
	...
	// REFERENCE OBTAINED NOTIFICATION FOR CUSTOMER
		...
		// Set email intro
		$introOutput  = '<p>Dear ' . $row->customer_name . ',</p>';
		$introOutput .= '<p>We hope you are looking forward to your trip</p>';
		$introOutput .= '<p>The week your are travelling, please phone ';
		if($caretaker_name !=''){
		...
		$introOutput .= ' with your arrival details to make arrangements for key collection details and checking out arrangements.</p>';
		$introOutput .= '<p>Note: **Failure to phone in advance as above <strong>may result in a delay in checking in</strong>**</p>';
		$introOutput .= 'For a map and details of any onsite charges please refer to our website here:</br>';
		$introOutput .= '<a href="https://irelandathome.com/property/' .$row->propertyCode. '">Your property detail page and map</a><br><br>';
	...
	// INSTRUCTIONS SENT NOTIFICATION TO CUSTOMER
		...
		$introOutput  = '<p>Dear ' . $row->customer_name . ',</p>';
		$introOutput .= '<p>We hope you are looking forward to your trip</p>';
		$introOutput .= '<p>The week your are travelling, please phone your caretaker, ';
		if($caretaker_name !=''){
			$introOutput .= $caretaker_name . ' ';
		}
		if($caretaker_number !=''){
		...
		$introOutput .= ' with your arrival details to make arrangements for key collection details and checking out arrangements</p>';
		$introOutput .= '<p>Note: **Failure to phone in advance as above <strong>may result in a delay in checking in</strong>**</p>';
		$introOutput .= 'For directions and any onsite charges please refer to our website here:</br>';
		$introOutput .= '<a href="https://irelandathome.com/property/' .$row->propertyCode. '">Your property detail page and map</a><br><br>';

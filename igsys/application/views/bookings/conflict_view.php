...
<table border="0">
<tr>
<?=form_open('booking/customer_conflict');?>
<br /><br />
...
<!-- Hidden field with booking data -->
...
<input type="hidden" name="accommCost" value="<?= $accommCost; ?>" />
...
<input type="hidden" name="chargePurpose" value="<?= $chargePurpose; ?>" />
<input type="hidden" name="chargeAmount" value="<?= $chargeAmount; ?>" />
<input type="hidden" name="bookingDiscount" value="<?= $bookingDiscount; ?>" />
<input type="hidden" name="commissionPercentage" value="<?= $commissionPercentage; ?>" />

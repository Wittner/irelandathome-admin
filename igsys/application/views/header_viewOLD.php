...
<!-- News ticker -->
<script src="jsfiles/news_ticker/ajaxticker.js" type="text/javascript"></script>
<!-- Animated divs -->
...
<div id="loginBar"><strong>Logged in:</strong> <?php echo $this->session->userdata('admin_name'); ?>, Ireland at Home. <?php echo date('l jS M Y ');?></div>

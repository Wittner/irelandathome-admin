<?php
/**
 * Global_settings - For getting and setting system vars
 * 
 ...
 * @access public
 */
class Global_settings extends Controller
{
...
/* End of file global_settings.php */
/* Location: ./system/controllers/global_settings.php */
...
class CI_Email {
	...
	var	$smtp_host		= "smtp.office365.com";		// SMTP Server.  Example: mail.blacknight.com
	var	$smtp_user		= "sales@irelandathome.com";		// SMTP Username
	var	$smtp_pass		= "selfcaterL1v3:";		// SMTP Password
	var	$smtp_port		= "587";		// SMTP Port (25)
